...
# From http://wiki.python.org/moin/PythonDecoratorLibrary#Type_Enforcement_.28accepts.2Freturns.29
# SPK's changes: Made the format string have {0} instead of {} cos it
# gave an error cos of version 2.6
